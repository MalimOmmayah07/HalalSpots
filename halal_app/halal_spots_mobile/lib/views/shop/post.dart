...
import 'add_post.dart'; // Changed to add_post.dart
import 'list_post.dart'; // Changed to list_post.dart
      ...
      body: Column(
        children: [
          TabBar(
            ...
            tabs: [
              const Tab(text: 'Add Post'), // Changed text
              const Tab(text: 'List'), // Kept List tab as is
            ],
          ),
          Expanded(
            child: TabBarView(
              controller: _tabController,
              children: [
                AddPost(), // Changed to AddPost widget
                PostList(), // Kept ListPost widget as is
              ],
            ),
          ),
        ],
